...
# Office Segment
office_segment = (
    sold_clean.groupby(["ListOfficeName", "BuyerOfficeName"])
    .agg(
...
display(property_segment.head(20))
display(location_segment.head(20))
display(office_segment.head(20))
